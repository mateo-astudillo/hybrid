...
class Login(CTkFrame):
    def __init__(self, parent):
        ...
        self.image = CTkLabel(
            master=self.imgContainer, image=self.my_image, text="", )
        ...
        self.username_entry = CTkEntry(
            master=self.entrysContainer, width=180, placeholder_text="Username", placeholder_text_color="black", text_color="black", fg_color="#fff", font=("Open Sans ExtraBold", 14))
        ...
        self.password_entry = CTkEntry(
            master=self.entrysContainer, width=180, placeholder_text="Password", placeholder_text_color="black", text_color="black", fg_color="#fff", font=("Open Sans ExtraBold", 14))
        ...
        self.button_register.configure(
            corner_radius=27, border_width=0, fg_color="black", hover_color="#C92C37", text_color="#fff", font=("Open Sans Light", 14))
